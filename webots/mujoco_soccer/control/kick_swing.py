...
def _kick_offsets(progress: float) -> dict[str, float]:
    ...
    return {
        ...
        "Right_Shoulder_Pitch": r_sh * scale,
        "Left_Shoulder_Pitch": l_sh * scale,
